    ...
    Link,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(
          "span",
          {
            className: `overflow-hidden whitespace-nowrap transition-[max-width,opacity] duration-300 ease-in-out ${collapsed ? "max-w-0 opacity-0" : "max-w-[12rem] opacity-100"}`,
      ...
      return /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(MaybeTooltip, { label, children: /* @__PURE__ */ jsxs(
          Link,
          {
            href: safeRoute(routeName, fallback),
            onClick: handleSidebarLinkClick,
            className: `flex min-h-12 w-full items-center gap-3 px-4 text-sm transition-colors duration-300 ${parentActive ? "bg-emerald-500 text-white" : "text-zinc-400 hover:bg-white/5 hover:text-white"}`,
            children: [
              ICONS[icon],
              /* @__PURE__ */ jsx(
                "span",
      ...
      Collapsible,
      {
        ...
        children: [
          /* @__PURE__ */ jsx(MaybeTooltip, { label, children: /* @__PURE__ */ jsx(CollapsibleTrigger, { asChild: true, children: /* @__PURE__ */ jsxs(
            "button",
            {
              className: `flex min-h-12 w-full items-center justify-between gap-3 px-4 text-sm transition-colors duration-300 ${parentActive ? "bg-emerald-500 text-white" : "text-zinc-400 hover:bg-white/5 hover:text-white"}`,
              children: [
                ...
                /* @__PURE__ */ jsx(
                  "span",
                  {
                    className: `overflow-hidden transition-[max-width,opacity] duration-300 ease-in-out ${collapsed ? "max-w-0 opacity-0" : "max-w-6 opacity-100"}`,
  ...
  const SidebarBody = () => /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "h-20 flex items-center px-5", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsx(
        "span",
        {
          className: `overflow-hidden whitespace-nowrap font-bold uppercase text-white transition-[max-width,opacity] duration-300 ease-in-out ${collapsed ? "max-w-0 opacity-0" : "max-w-[8rem] opacity-100"}`,
          children: "Apex"
        }
      )
    ] }) }),
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(MaybeTooltip, { label: dashboardLabel, children: /* @__PURE__ */ jsxs(
              Link,
              {
                ...
                onClick: handleSidebarLinkClick,
                className: `flex min-h-12 items-center gap-3 px-4 transition-colors duration-300 ${isDashboardActive ? "bg-emerald-500 text-white" : "text-zinc-400 hover:bg-white/5 hover:text-white"}`,
                children: [
                  ICONS.dashboard,
                  /* @__PURE__ */ jsx(
                    "span",
                    {
                      className: `overflow-hidden whitespace-nowrap transition-[max-width,opacity] duration-300 ease-in-out ${collapsed ? "max-w-0 opacity-0" : "max-w-[12rem] opacity-100"}`,
                      children: /* @__PURE__ */ jsx("span", { className: "truncate", children: dashboardLabel })
                    }
                  )
                ]
              }

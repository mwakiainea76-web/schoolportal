...
import { User, ShieldCheck, CalendarDays, Grid2X2, FileText, Building2, Award, BookOpen, LayoutDashboard, ChevronLeft } from "lucide-react";
...
const ICONS = {
  ...
  certificate: /* @__PURE__ */ jsx(Award, { className: "w-5 h-5 shrink-0" }),
  department: /* @__PURE__ */ jsx(Building2, { className: "w-5 h-5 shrink-0" }),
  file: /* @__PURE__ */ jsx(FileText, { className: "w-5 h-5 shrink-0" }),
  grid: /* @__PURE__ */ jsx(Grid2X2, { className: "w-5 h-5 shrink-0" }),
  academic: /* @__PURE__ */ jsx(CalendarDays, { className: "w-5 h-5 shrink-0" }),
  roles: /* @__PURE__ */ jsx(ShieldCheck, { className: "w-5 h-5 shrink-0" }),
  user: /* @__PURE__ */ jsx(User, { className: "w-5 h-5 shrink-0" })
};
...
function Sidebar({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(
      "aside",
      {
        className: `fixed lg:static inset-y-0 left-0 z-50 flex flex-col bg-[#1b263b] transform transition duration-300 ${mobileOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"} ${collapsed ? "w-20" : "w-64"}`,
        children: [
          ...
          /* @__PURE__ */ jsxs("nav", { className: "flex-1 overflow-y-auto", children: [

...
function EditProgramVersion({
  ...
  useEffect(() => {
    ...
    setData({
      ...
      exam_body_id: programVersionMapping.program?.certification_level?.exam_body_id ?? programVersionMapping.program?.certificationLevel?.exam_body_id ?? ""
    });
    ...
    /* @__PURE__ */ jsx("div", { className: "mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-700", children: /* @__PURE__ */ jsx("div", { className: "bg-white rounded-lg border border-zinc-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden", children: /* @__PURE__ */ jsxs("form", { className: "p-10 space-y-8", onSubmit: submit, children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx(
            SearchSelect,
            {
              ...
              selectedLabel: programVersionMapping?.program?.certification_level?.exam_body ? `${courseVersionMapping.course.certification_level.exam_body.code} - ${courseVersionMapping.course.certification_level.exam_body.name}` : programVersionMapping?.program?.certificationLevel?.examBody ? `${courseVersionMapping.course.certificationLevel.examBody.code} - ${courseVersionMapping.course.certificationLevel.examBody.name}` : void 0,
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between pt-4", children: [
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            disabled: processing || !programVersionMapping,
            type: "submit",

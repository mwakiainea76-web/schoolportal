...
function Create({ feePlans, academicYear, curriculums }) {
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-700", children: /* @__PURE__ */ jsxs("div", { className: "overflow-hidden rounded-lg border border-zinc-100 bg-white shadow-sm", children: [
      /* @__PURE__ */ jsx("div", { className: "bg-slate-400 py-2 text-center text-sm font-medium text-white", children: "Create Program Version Fee Assignment" }),
      /* @__PURE__ */ jsxs("form", { className: "space-y-8 p-10", onSubmit: submit, children: [
        !canCreateAssignment ? /* @__PURE__ */ jsx("div", { className: "rounded border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-700", children: "You cannot create a fee assignment until an academic year, a fee plan, and a program version mapping exist." }) : null,

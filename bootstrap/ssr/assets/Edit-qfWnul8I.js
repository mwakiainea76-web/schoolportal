...
const Edit = ({ curriculum }) => {
  ...
  const { data, setData, put, processing, errors } = useForm({
    ...
    exam_body_id: c?.exam_body_id || c?.course?.certification_level?.exam_body_id || "",
    name: c?.name || "",
  ...
  const submit = (e) => {
    e.preventDefault();
    put(route("course-versions.update", c.id), {
      preserveState: true,
      preserveScroll: true
    });
  };
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx(
                  SearchSelect,
                  {
                    ...
                    selectedLabel: c?.course?.display_name || c?.course?.name,

...
function CreateStudent({
  ...
  const [curriculumOptions, setCurriculumOptions] = useState(programVersions);
  const [loadingCurricula, setLoadingCurricula] = useState(false);
  const hasProgramVersions = curriculumOptions.length > 0;
  const handleChange = (e) => setData(e.target.name, e.target.value);
  useEffect(() => {
    localStorage.setItem(STORAGE_KEY, JSON.stringify(data));
  }, [data]);
  useEffect(() => {
    setCurriculumOptions(programVersions);
  }, [programVersions]);
  useEffect(() => {
    if (!data.program_id) {
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "mx-auto w-full", children: /* @__PURE__ */ jsx("div", { className: "rounded-xl pt-2", children: /* @__PURE__ */ jsx("div", { className: "overflow-visible rounded-xl border bg-white shadow-sm", children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-5 p-0", children: [
      ...
      /* @__PURE__ */ jsxs("section", { className: "overflow-visible rounded-lg", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "p-4", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3", children: [
          data.program_id && !hasProgramVersions && !loadingCurricula ? /* @__PURE__ */ jsx("div", { className: "rounded border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-700 md:col-span-2 xl:col-span-3", children: "No active curriculum versions are available for the selected course." }) : null,
          /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx(
              SearchSelect,
              {
                ...
                disabled: !data.program_id || loadingCurricula,
              ...
              `curriculum-${data.program_id}-${curriculumOptions.length}`
            ),
            data.program_id && curriculumOptions.length > 1 ? /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-amber-600", children: "Multiple active curriculum versions exist. Select one for this student." }) : null,
            /* @__PURE__ */ jsx(
              InputError,
              {

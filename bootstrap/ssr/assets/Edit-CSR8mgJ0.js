  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "mx-auto w-full", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-lg border shadow overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("form", { className: "w-full p-10 space-y-8", onSubmit: submit, children: [
        !hasExamBodies ? /* @__PURE__ */ jsx("div", { className: "rounded border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-700", children: "You cannot update this certification level until an exam body exists." }) : null,
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 xl:grid-cols-3", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            !hasExamBodies ? /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-amber-600", children: "Create an exam body first to continue." }) : null,

...
import "ziggy-js";
function ProgramVersionMappingsIndex({
  programVersionMappings
}) {
        ...
        DirectoryTable,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(TBody, { children: programVersionMappings?.data?.length ? programVersionMappings.data.map((mapping) => /* @__PURE__ */ jsxs(Trow, { children: [
              ...
              /* @__PURE__ */ jsx(Tdata, { children: mapping.program?.certification_level?.exam_body ? `${mapping.course.certification_level.exam_body.code} - ${mapping.course.certification_level.exam_body.name}` : "-" }),

...
function Index({ curriculum_units }) {
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Program Version Units" }),
    /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
      /* @__PURE__ */ jsx(
        Link,
        {
          ...
          children: "Add Program Version Units"
        }
      ),
      /* @__PURE__ */ jsxs(
        "form",
        ...
        DirectoryTable,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs(Thead, { children: [
              ...
              /* @__PURE__ */ jsx(THdata, { className: "text-center", children: "Program" }),
              /* @__PURE__ */ jsxs(
                THdata,
                {
            ...
            /* @__PURE__ */ jsx(TBody, { children: curriculum_units?.data?.length ? curriculum_units.data.map((item) => /* @__PURE__ */ jsxs(Trow, { children: [
              ...
              /* @__PURE__ */ jsx(Tdata, { children: item.program_version_mapping?.program?.name }),
              /* @__PURE__ */ jsx(Tdata, { children: item.program_version_mapping?.program_version?.name }),

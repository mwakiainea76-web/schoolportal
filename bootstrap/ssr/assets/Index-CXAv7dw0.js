...
function FeeAssignmentsIndex({ assignments, filters }) {
  ...
  const courseCertificationLabel = (assignment) => {
    ...
    const certificationName = assignment.course_curriculum?.course?.certificationLevel?.name || assignment.course_curriculum?.course?.certification_level?.name;

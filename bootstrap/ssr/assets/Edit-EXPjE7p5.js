...
import "ziggy-js";
function Edit({ component, templates }) {
  const { data, setData, put, processing, errors } = useForm({
    fee_template_id: component?.fee_template_id ?? "",
    name: component?.name ?? "",
    type: component?.type ?? "",
    // FIXED: safe amount hydration (no falsy overwrite)
    amount: component?.amount !== null && component?.amount !== void 0 ? String(component.amount) : "",
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Edit Fee Component" }),
    /* @__PURE__ */ jsx("div", { className: "mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-700", children: /* @__PURE__ */ jsx("div", { className: "bg-white rounded-lg border border-zinc-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden", children: /* @__PURE__ */ jsxs("form", { className: "p-10 space-y-8", onSubmit: submit, children: [
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(InputLabel, { value: "Fee Template" }),
          /* @__PURE__ */ jsx(
            SearchSelect,
            {
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(InputLabel, { value: "Component Name" }),
          /* @__PURE__ */ jsx(
            TextInput,
            {
              value: data.name,

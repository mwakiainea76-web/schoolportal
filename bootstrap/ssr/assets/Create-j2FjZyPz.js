...
function CreateDepartment() {
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-700", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-lg border border-zinc-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx(
              SearchSelect,
              {
                ...
                onChange: (staff) => setData("hod_staff_id", staff.id),

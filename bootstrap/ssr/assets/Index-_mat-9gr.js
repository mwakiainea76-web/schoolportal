...
import "ziggy-js";
function ProgramVersionMappingsIndex({ programVersionMappings }) {
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Program Version Mapping" }),
    /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
      /* @__PURE__ */ jsx(
        Link,
        {
          ...
          children: "Add Program Version Mapping"
        }
      ),
      /* @__PURE__ */ jsxs(
        "form",
      ...
      /* @__PURE__ */ jsxs(
        DirectoryTable,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(TBody, { children: programVersionMappings?.data?.length ? programVersionMappings.data.map((mapping) => /* @__PURE__ */ jsxs(Trow, { children: [
              /* @__PURE__ */ jsx(Tdata, { children: mapping.program_version?.name }),
              /* @__PURE__ */ jsx(Tdata, { children: mapping.program?.name ?? "-" }),
            ...
            ] }, mapping.id)) : /* @__PURE__ */ jsx(Trow, { children: /* @__PURE__ */ jsx(Tdata, { colSpan: "5", className: "py-4 text-center", children: "No program version mappings found." }) }) })
          ]
        }
      )
    ] })
...
export {
  ProgramVersionMappingsIndex as default
};

...
function FeeAssignmentsIndex({ assignments, filters }) {
  ...
  const programCertificationLabel = (assignment) => {
    const programName = assignment.program_version_mapping?.program?.name || assignment.course_curriculum?.course?.name;
    const certificationName = assignment.program_version_mapping?.program?.certificationLevel?.name || assignment.program_version_mapping?.program?.certification_level?.name || assignment.course_curriculum?.course?.certificationLevel?.name || assignment.course_curriculum?.course?.certification_level?.name;
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
          /* @__PURE__ */ jsx(
            Link,
            {
              ...
              children: "+ Add Program Version Fee Assignment"
            }
          ),
          /* @__PURE__ */ jsx(
            "button",
        ...
        DirectoryTable,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(TBody, { children: assignments?.data?.length ? assignments.data.map((item) => /* @__PURE__ */ jsxs(Trow, { children: [
              /* @__PURE__ */ jsx(Tdata, { children: programCertificationLabel(item) }),

...
import { u as useRbac, A as AuthenticatedLayout } from "./AuthenticatedLayout-DYCvRbZH.js";
...
import "ziggy-js";
function ProgramVersionIndex({ curricula }) {
  ...
  const handleDelete = (id) => {
    if (!confirm("Are you sure you want to delete this program version?")) {
      return;
    }
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Program Versions" }),
    /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
      /* @__PURE__ */ jsx(
        Link,
        {
          ...
          href: route("program-versions.create"),
          children: "Add Program Version"
        }
      ),
          ...
          children: [
            /* @__PURE__ */ jsx(
              SearchSelect,
              {
                ...
                placeholder: "Type in program version name ...",
      ...
      /* @__PURE__ */ jsxs(
        DirectoryTable,
        {
          ...
          children: [
            ...
            ] }, curriculum.id)) : /* @__PURE__ */ jsx(Trow, { children: /* @__PURE__ */ jsx(Tdata, { colSpan: "7", className: "text-center py-4", children: "No program versions found." }) }) })
          ]
        }
      )
    ] })

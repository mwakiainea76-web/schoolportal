...
function Index({
  ...
  is_hod || is_trainer ? Boolean(current_department_id) : Boolean(
    filters.department_id && filters.program_version_mapping_id && filters.module_number
  );
  ...
  const adminLoadPathReady = is_hod || is_trainer ? Boolean(current_department_id) : Boolean(
    filters.academic_session_id && filters.department_id && (filters.trainer_staff_id || filters.program_version_mapping_id && filters.module_number)
  );
                ...
                is_hod || is_trainer ? /* @__PURE__ */ jsxs(
                  "select",
                  {
                    ...
                    children: [
                      ...
                      program_options.map((program) => /* @__PURE__ */ jsx("option", { value: program.id, children: program.name }, program.id))
                    ]
                  }
                ) : /* @__PURE__ */ jsx(
                  SearchSelect,

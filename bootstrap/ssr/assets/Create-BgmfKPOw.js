...
function Create({ departments }) {
  ...
  const submit = (e) => {
    e.preventDefault();
    post(route("lecture-rooms.store"), {
      preserveScroll: true,
      onSuccess: () => reset()
    });
  };
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Add Lecture Room" }),
    /* @__PURE__ */ jsx("div", { className: "mx-auto w-full max-w-4xl animate-in fade-in slide-in-from-bottom-4 duration-700", children: /* @__PURE__ */ jsx("div", { className: "overflow-hidden rounded-lg border border-zinc-100 bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)]", children: /* @__PURE__ */ jsxs("form", { className: "space-y-8 p-10", onSubmit: submit, children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h1", { className: "text-2xl font-semibold text-zinc-900", children: "Add Lecture Room" }),
        /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-zinc-500", children: "Create halls and classrooms that timetable sessions can use during departmental planning." })
      ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between pt-4", children: [
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: processing ? "Saving..." : "Save Room"
          }
        )
      ] })
    ] }) }) })

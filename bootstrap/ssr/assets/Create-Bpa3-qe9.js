...
function Create({ feePlans, academicYear, curriculums }) {
  ...
  const canCreateAssignment = hasAcademicYears && hasFeePlans && hasCourseVersions;
      ...
      /* @__PURE__ */ jsxs("form", { className: "space-y-8 p-10", onSubmit: submit, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            !hasCourseVersions ? /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-amber-600", children: "Create a course version mapping first to continue." }) : null,
            /* @__PURE__ */ jsx(
              InputError,
              {

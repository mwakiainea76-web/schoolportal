          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "mt-2", children: /* @__PURE__ */ jsx(
              SearchSelect,
              {
                ...
                selectedLabel: unit_options.find(
                  (unit) => String(unit.id) === String(
                    filterForm.data.curriculum_unit_id
                  )
                )?.display_name || selected_unit?.display_name || null,
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "mt-2", children: /* @__PURE__ */ jsx(
              SearchSelect,
              {
                ...
                selectedLabel: filter_options?.academic_years?.find(
                  (year) => String(year.value) === String(
                    filterForm.data.academic_year_id
                  )
                )?.label || selected_filters?.academic_year?.name,
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "mt-2", children: /* @__PURE__ */ jsx(
              SearchSelect,
              {
                ...
                selectedLabel: filter_options?.sessions?.find(
                  (session) => String(session.value) === String(
                    filterForm.data.academic_session_id
                  )
                )?.label || selected_filters?.academic_session?.name,

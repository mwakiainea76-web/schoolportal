  ...
  return /* @__PURE__ */ jsxs(
    AuthenticatedLayout,
    {
      header: /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-2 max-w-3xl text-sm text-zinc-600", children: "Plan a real class session with trainer, hall, and one or more equivalent curriculum units that can be taught together across courses." })
      ] }),
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-5xl", children: /* @__PURE__ */ jsxs(
          "form",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("div", { className: "rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4 text-sm text-amber-800", children: "A trainer can merge students from different courses into one class when the content is the same. Select all matching curriculum units below, then assign one room and one weekly slot for that merged teaching session." }),

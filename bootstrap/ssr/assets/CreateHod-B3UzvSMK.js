...
function CreateHod({
  ...
  useEffect(() => {
    const messages = Object.entries(errors).filter(
      ([key, value]) => Boolean(value) && (key.startsWith("sessions.") || key === "curriculum_unit_ids" || key === "trainer_staff_id" || key === "lecture_room_id")
    ).map(([, value]) => value);
    if (messages.length) {
      alert(messages[0]);
    }
  ...
  const updateScopedFilters = (nextValues) => {
    const nextCurriculumMappingId = nextValues.curriculum_mapping_id ?? data.curriculum_mapping_id;
    const nextModuleNumber = nextValues.module_number ?? data.module_number;
    router.get(
      route("academic.timetables.hod.create"),
      {
        curriculum_mapping_id: nextCurriculumMappingId || "",
  ...
  return /* @__PURE__ */ jsxs(
    AuthenticatedLayout,
    {
      header: /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-2 max-w-3xl text-sm text-zinc-600", children: "Your department is detected automatically. Choose one active curriculum, narrow to a module, then assign equivalent units together into one trainer, room, and weekly slot." })
      ] }),
      children: [
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-4 rounded-2xl border border-zinc-200 bg-zinc-50 p-5", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-sm text-zinc-500", children: "Choose every curriculum unit that shares the same content and can be merged into one teaching room and slot." })
                ] }),
                /* @__PURE__ */ jsx(
                  InputError,
                  {
                ...
                }) : /* @__PURE__ */ jsx("p", { className: "text-sm text-zinc-400", children: data.curriculum_mapping_id && data.module_number ? "No unassigned curriculum units are available for this course and module." : "Choose a versioned course and module to load curriculum units." }) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "grid gap-6 sm:grid-cols-2", children: [
                /* @__PURE__ */ jsxs("div", { children: [

...
import "ziggy-js";
function Create({ curriculum_mapping, selected_mapping_option }) {
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full max-w-7xl animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
      /* @__PURE__ */ jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsx(CourseWorkspaceTabs, { activeTab: "add-unit" }) }),
      /* @__PURE__ */ jsx("div", { className: "overflow-hidden rounded-lg border border-zinc-100 bg-white shadow-sm", children: /* @__PURE__ */ jsxs("form", { className: "space-y-6 p-8", onSubmit: submit, children: [

...
function CourseChange({
  ...
  const selectedCourse = curriculumMappings.find(
    (course) => String(course.id) === String(transferForm.data.new_curriculum_mapping_id)
  );
  const isSameCourse = student && selectedCourse && Number(student.current_curriculum_mapping_id) === Number(selectedCourse.id);
        ...
        /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-5xl space-y-6", children: [
          latestTransfer ? /* @__PURE__ */ jsxs("section", { className: "rounded-3xl border border-zinc-200 bg-white p-6 text-sm text-zinc-900 shadow-sm", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "mt-4 grid gap-3 md:grid-cols-2", children: [
              /* @__PURE__ */ jsx(Info, { label: "Old admission number", value: latestTransfer.old_admission_number }),
              /* @__PURE__ */ jsx(Info, { label: "New admission number", value: latestTransfer.new_admission_number }),
          ...
          /* @__PURE__ */ jsxs("section", { className: "rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm", children: [
            /* @__PURE__ */ jsxs("form", { onSubmit: lookupStudent, className: "grid gap-4 md:grid-cols-[1fr,auto] md:items-end", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx(InputLabel, { value: "Existing Admission Number", required: true }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
                ...
                /* @__PURE__ */ jsx(InputError, { message: lookupForm.errors.admission_number, className: "mt-2" })
              ] }),
              /* @__PURE__ */ jsx(
                "button",
                {
                ...
                /* @__PURE__ */ jsxs(
                  "select",
                  {
                    ...
                    children: [
                      ...
                      curriculumMappings.map((course) => /* @__PURE__ */ jsx("option", { value: course.id, children: course.name }, course.id))
                    ]
                  }
                ),
                /* @__PURE__ */ jsx(InputError, { message: transferForm.errors.new_curriculum_mapping_id, className: "mt-2" }),

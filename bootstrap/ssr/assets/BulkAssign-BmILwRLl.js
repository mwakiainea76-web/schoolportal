    ...
    /* @__PURE__ */ jsx("div", { className: "mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-700", children: /* @__PURE__ */ jsxs("div", { className: "overflow-hidden rounded-lg border bg-white shadow-sm", children: [
      ...
      /* @__PURE__ */ jsxs("form", { className: "space-y-8 p-8", onSubmit: submit, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "rounded-lg border", children: [
          ...
          ) }) : rows.length === 0 ? /* @__PURE__ */ jsx("div", { className: "px-4 py-6 text-sm text-slate-500", children: data.fee_plan_id && data.academic_year_id && data.department_id && data.certification_level_id && data.year_of_study && data.session_number ? "No program versions found for the selected department and certification level." : "Select fee plan, academic year, department, certification level, year of study, and session number to load program versions." }) : /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-slate-200 text-sm", children: [

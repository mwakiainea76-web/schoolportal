...
function CourseChange({
  ...
  const selectedCourse = courseCurricula.find(
    (course) => String(course.id) === String(transferForm.data.new_program_version_mapping_id)
  );
  const isSameCourse = student && selectedCourse && Number(student.current_program_version_mapping_id) === Number(selectedCourse.id);
          ...
          student ? /* @__PURE__ */ jsxs("section", { className: "rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm", children: [
            ...
            /* @__PURE__ */ jsxs("form", { onSubmit: submitTransfer, className: "mt-6 space-y-5", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx(InputError, { message: transferForm.errors.new_program_version_mapping_id, className: "mt-2" }),

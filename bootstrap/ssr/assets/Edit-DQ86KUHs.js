...
const Edit = ({ curriculum }) => {
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Edit Program Version" }),
    /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full", children: [
      /* @__PURE__ */ jsx("legend", { className: "text-white border-b border-white/50 text-center py-2 bg-slate-400 rounded-t-lg w-full", children: "Edit program version details" }),
      /* @__PURE__ */ jsxs(
        "form",
        {
          onSubmit: submit,
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx(
                  "p",
                  {
                    ...
                    children: isVersionStateLocked ? "This program version is closed and cannot be reactivated." : lifecycleText
                  }
                )
              ] })
            ] }),

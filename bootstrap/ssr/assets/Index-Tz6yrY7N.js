...
function ReportsIndex({
  ...
  if (loading) {
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "flex h-64 items-center justify-center", children: /* @__PURE__ */ jsx(LoadingSpinner, { size: "lg", centered: true }) })
    ] });
  }
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Head, { title: pageTitle }),
                ...
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-4", children: [
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsx("p", { className: "text-sm text-zinc-500", children: student.admission_number })
                    ] }),
              ...
              (payment) => /* @__PURE__ */ jsxs(
                "tr",
                {
                  children: [
                    ...
                    /* @__PURE__ */ jsx("td", { className: "px-4 py-3 text-sm text-zinc-700", children: payment.admission_number || "-" }),
            ...
            /* @__PURE__ */ jsx("div", { className: "space-y-4", children: hostelSummary.exceptions.duplicate_allocations?.length ? hostelSummary.exceptions.duplicate_allocations.map(
              (row) => /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("p", { className: "font-medium text-zinc-800", children: row.student_name }),
                    /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-zinc-500", children: row.admission_number }),
                    /* @__PURE__ */ jsxs("p", { className: "mt-2 text-sm font-semibold text-red-600", children: [
              ...
              (row) => /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-zinc-500", children: formatCurrency(
                      row.amount
                    ) })
                  ]
                },
          ...
          /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-zinc-200", children: [
            ...
            /* @__PURE__ */ jsxs("tbody", { className: "divide-y divide-zinc-200 bg-white", children: [
              outstandingBalance.map(
                (item, index) => /* @__PURE__ */ jsxs("tr", { children: [
            ...
            /* @__PURE__ */ jsxs("tbody", { className: "divide-y divide-zinc-200 bg-white", children: [
              overdueByDepartment.map(
                (item, index) => /* @__PURE__ */ jsxs("tr", { children: [
                  ...
                  /* @__PURE__ */ jsx("td", { className: "whitespace-nowrap px-6 py-4 text-sm font-medium text-red-600", children: formatCurrency(
                    item.total_overdue
                  ) }),

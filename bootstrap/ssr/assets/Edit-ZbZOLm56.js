      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-4xl", children: /* @__PURE__ */ jsxs(
          "form",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("div", { className: "rounded-2xl border border-sky-200 bg-sky-50 px-5 py-4 text-sm text-sky-800", children: "This form edits one weekly class session. That class can still represent multiple programs sharing the same content in one hall." }),

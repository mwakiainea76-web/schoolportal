...
import Edit$1 from "./Edit-Dt054cCD.js";
import "ziggy-js";
...
function Index({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "mx-auto w-full max-w-7xl animate-in fade-in slide-in-from-bottom-4 duration-700", children: /* @__PURE__ */ jsxs("div", { className: "flex w-full flex-col gap-6 lg:flex-row lg:items-start", children: [

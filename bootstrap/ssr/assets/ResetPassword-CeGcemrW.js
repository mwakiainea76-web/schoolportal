...
function ResetStudentPassword() {
  ...
  const isFormIncomplete = !form.data.admission_number.trim() || !form.data.password || !form.data.password_confirmation;
  const submit = (e) => {
    e.preventDefault();
    form.post(route("students.password-reset.store"), {
      preserveScroll: true,
      onSuccess: () => form.reset("password", "password_confirmation")
    });
  };
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Reset Student Password" }),
    /* @__PURE__ */ jsx("div", { className: "mx-auto w-full max-w-5xl py-6", children: /* @__PURE__ */ jsx("div", { className: "rounded-[28px] border border-zinc-200 bg-white shadow-sm", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-6 px-8 py-8 lg:grid-cols-[0.85fr_1.15fr]", children: [
      /* @__PURE__ */ jsxs("section", { className: "rounded-2xl border border-zinc-200 bg-zinc-50/70 p-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-xl bg-white text-emerald-700 shadow-sm", children: /* @__PURE__ */ jsx(GraduationCap, { className: "h-5 w-5" }) }),
          /* @__PURE__ */ jsx("h2", { className: "text-base font-semibold text-zinc-900", children: "Student Account Recovery" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mt-5 space-y-4 text-sm text-zinc-600", children: [
          /* @__PURE__ */ jsx("p", { children: "Enter the admission number and choose a new password for that account." }),
...
export {
  ResetStudentPassword as default
};

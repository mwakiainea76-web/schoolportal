  ...
  return /* @__PURE__ */ jsxs(
    AuthenticatedLayout,
    {
      header: /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-2 max-w-3xl text-sm text-zinc-600", children: "Enter the curriculum unit code, then fill admission numbers and marks manually." })
      ] }),
      children: [
            ...
            "form",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx(InputLabel, { value: "Curriculum Unit Code", required: true }),
                  /* @__PURE__ */ jsx(
                    "input",
                    {
                      type: "text",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "overflow-hidden rounded-2xl border border-zinc-100", children: [
                  /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4 bg-zinc-50 px-4 py-3 text-xs font-semibold uppercase tracking-wide text-zinc-500", children: [
                    /* @__PURE__ */ jsx("p", { children: "Admission Number" }),
                      ...
                      children: [
                        /* @__PURE__ */ jsxs("div", { children: [
                          ...
                          /* @__PURE__ */ jsx(
                            InputError,
                            {
                              message: marksForm.errors[`entries.${index}.admission_number`],
                              className: "mt-2"
                            }
                          )
                        ] }),

...
const signedCurrency = (amount) => `${Number(amount || 0) < 0 ? "-" : ""}Ksh ${new Intl.NumberFormat("en-KE", {
  minimumFractionDigits: 2,
  maximumFractionDigits: 2
...
function Show({ invoice, sessionSummary }) {
  ...
  const course = invoice.enrollment?.course_enrollment?.curriculum_mapping?.course?.name ?? "Not linked";
  const curriculum = invoice.enrollment?.course_enrollment?.curriculum_mapping?.curriculum?.name ?? "Not linked";
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-5 grid gap-4 md:grid-cols-2", children: [
            ...
            /* @__PURE__ */ jsx(
              InfoCard,
              {
                ...
                value: invoice.student?.admission_number ?? "N/A"
              }
            ),
            /* @__PURE__ */ jsx(InfoCard, { label: "Course", value: course }),
            /* @__PURE__ */ jsx(InfoCard, { label: "Curriculum", value: curriculum }),
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsx("p", { className: "text-sm text-zinc-500", children: formatDate(
                      sessionInvoice.issue_date
                    ) })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "text-left sm:text-right", children: [
                    /* @__PURE__ */ jsx("p", { className: "font-medium text-zinc-900", children: currency(
        ...
        /* @__PURE__ */ jsxs("section", { className: "rounded-[1.75rem] border border-zinc-100 bg-white p-6 shadow-sm", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "mt-5 overflow-hidden rounded-2xl border border-zinc-100", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-zinc-100", children: [
            ...
            /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-zinc-100 bg-white", children: sessionPayments.length ? sessionPayments.map((allocation) => /* @__PURE__ */ jsxs("tr", { children: [
              /* @__PURE__ */ jsx("td", { className: "px-5 py-4 text-sm text-zinc-700", children: formatDate(
              ...
              /* @__PURE__ */ jsx("td", { className: "px-5 py-4 text-right text-sm font-semibold text-emerald-700", children: currency(
                allocation.amount
              ) })
        ...
        /* @__PURE__ */ jsxs("section", { className: "rounded-[1.75rem] border border-zinc-100 bg-white p-6 shadow-sm", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "mt-5 overflow-hidden rounded-2xl border border-zinc-100", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-zinc-100", children: [
            ...
            /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-zinc-100 bg-white", children: sessionAdjustments.length ? sessionAdjustments.map((adjustment) => {
              ...
              const effectAmount = adjustment.type === "refund" ? 0 : reducesInvoice ? -Number(
                adjustment.amount
              ) : Number(
                adjustment.amount
              );
              return /* @__PURE__ */ jsxs("tr", { children: [
                ...
                /* @__PURE__ */ jsxs(
                  "td",
                  {
                    ...
                    children: [
                      adjustment.type === "refund" ? currency(
                        adjustment.amount
                      ) : signedCurrency(
                        effectAmount
                      ),

      ...
      /* @__PURE__ */ jsxs(
        DirectoryTable,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(TBody, { children: academic_sessions?.data?.length ? academic_sessions.data.map((session, idx) => /* @__PURE__ */ jsxs(Trow, { children: [
              /* @__PURE__ */ jsx(Tdata, { children: idx + 1 }),
              ...
              /* @__PURE__ */ jsxs(Tdata, { children: [
                session.end_date && session.start_date && /* @__PURE__ */ jsx(
                  "span",
                  {
                ...
                session.start_date && session.is_active == true && /* @__PURE__ */ jsx(
                  "span",
                  {
                ...
                !session.start_date && session.is_active == false && /* @__PURE__ */ jsx(
                  "span",
                  {

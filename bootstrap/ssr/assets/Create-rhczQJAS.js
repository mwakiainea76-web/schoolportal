...
function CreateStudent({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "mx-auto w-full", children: /* @__PURE__ */ jsx("div", { className: "rounded-xl pt-2", children: /* @__PURE__ */ jsx("div", { className: "overflow-visible  ", children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-5 p-0", children: [
      ...
      /* @__PURE__ */ jsx(FormSection, { number: "2", title: "Academic Details", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3", children: [
        data.exam_body_id && !hasCurriculums && !loadingCurriculums ? /* @__PURE__ */ jsx("div", { className: "rounded border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-700 md:col-span-2 xl:col-span-3", children: "No active curriculum versions are available for the selected exam body." }) : null,
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(
            InputLabel,
            {
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx(
            ...
            `curriculum-${data.exam_body_id}-${curriculumOptions.length}`
          ),
          data.exam_body_id && curriculumOptions.length > 1 ? /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-amber-600", children: "Multiple active curriculums exist. Select one for this student." }) : null,
          /* @__PURE__ */ jsx(
            InputError,
            {
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx(
            ...
            `course-${data.curriculum_id}-${courseOptions.length}`
          ),
          data.curriculum_id && !hasCoursesForVersion && !loadingCourses ? /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-amber-600", children: "No active courses are mapped to this curriculum yet." }) : null,
          /* @__PURE__ */ jsx(
            InputError,
            {

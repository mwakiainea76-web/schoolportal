...
function EditStudent({
  ...
  const existingCourseVersionMappingId = student.course_enrollment?.course_version_mapping_id || student.courseEnrollment?.course_version_mapping_id || "";
  const existingcourseId = student.course_enrollment?.course_id || student.courseEnrollment?.course_id || student.course_enrollment?.course_version_mapping?.course?.id || student.courseEnrollment?.courseVersionMapping?.course?.id || "";
  const existingExamBodyId = student.course_enrollment?.exam_body_id || student.courseEnrollment?.exam_body_id || student.course_enrollment?.course_version_mapping?.course?.certification_level?.exam_body_id || student.courseEnrollment?.courseVersionMapping?.course?.certificationLevel?.exam_body_id || "";
  const existingCourseVersionId = student.course_enrollment?.course_version_mapping?.course_version_id || student.courseEnrollment?.courseVersionMapping?.course_version_id || student.course_enrollment?.course_version_mapping?.courseVersion?.id || student.courseEnrollment?.courseVersionMapping?.courseVersion?.id || "";
  ...
  const selectedcourseLabel = student.course_enrollment?.course?.display_name || student.courseEnrollment?.course?.display_name || student.course_enrollment?.course?.name || student.courseEnrollment?.course?.name || student.course_enrollment?.course_version_mapping?.course?.name || student.courseEnrollment?.courseVersionMapping?.course?.name || "";
  const selectedCurriculumLabel = student.course_enrollment?.course_version?.name || student.courseEnrollment?.courseVersion?.name || student.course_enrollment?.course_version_mapping?.course_version?.name || student.courseEnrollment?.courseVersionMapping?.courseVersion?.name || "";
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "rounded-xl pt-2", children: /* @__PURE__ */ jsx("div", { className: "overflow-visible rounded-xl border bg-white shadow-sm", children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-5 p-0", children: [
        ...
        /* @__PURE__ */ jsxs("section", { className: "overflow-visible rounded-lg", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "p-4", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3", children: [
            data.course_id && !hasCourseVersionMappings && !loadingCourses && !hasLockedCourseEnrollment ? /* @__PURE__ */ jsx("div", { className: "rounded border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-700 md:col-span-2 xl:col-span-3", children: "No active curriculum versions are available for the selected course." }) : null,
            /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx(
                SearchSelect,
                {
                  ...
                  disabled: hasLockedCourseEnrollment || !data.course_id || loadingCourses,
                ...
                `curriculum-${data.course_id || data.course_version_id}-${courseOptions.length}`
              ),
              hasLockedCourseEnrollment ? /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-slate-500", children: "Enrollment curriculum is locked after admission." }) : data.course_id && !hasCourseVersionMappings && !loadingCourses ? /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-amber-600", children: "No active curricula are assigned to this course yet." }) : null,
              /* @__PURE__ */ jsx(
                InputError,
                {

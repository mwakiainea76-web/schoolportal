    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-3xl font-semibold text-zinc-900", children: "Hostels" }),
          /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-zinc-500", children: "Manage boarding hostels, room capacity, and the bed inventory used for per-session allocations." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex gap-3", children: [
          /* @__PURE__ */ jsx(Link, { href: route("hostel-allocations.index"), className: "rounded bg-slate-600 px-4 py-2 text-white hover:bg-slate-700", children: "Hostel Allocations" }),
          /* @__PURE__ */ jsx(Link, { href: route("hostels.create"), className: "rounded bg-emerald-600 px-4 py-2 text-white hover:bg-emerald-700", children: "Add Hostel" })
        ] })
      ] }),
      /* @__PURE__ */ jsx(
        "form",

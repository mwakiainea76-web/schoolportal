...
function ReportsIndex({
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
      ...
      showExecutive && executiveSummary && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-6 xl:grid-cols-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-zinc-100 bg-white p-6 shadow-sm", children: [
            /* @__PURE__ */ jsx("h2", { className: "mb-4 text-lg font-semibold text-zinc-700", children: "Top Programs By Enrollment" }),
            /* @__PURE__ */ jsx("div", { className: "space-y-4", children: executiveSummary.breakdowns.top_programs?.length ? executiveSummary.breakdowns.top_programs.map(
              (program) => /* @__PURE__ */ jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-4", children: [
                    /* @__PURE__ */ jsx("p", { className: "font-medium text-zinc-800", children: program.name }),
            ...
            ) : /* @__PURE__ */ jsx("p", { className: "text-sm text-zinc-500", children: "No program enrollment data available." }) })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-zinc-100 bg-white p-6 shadow-sm", children: [
      ...
      showAdmissions && admissionsSummary && /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-6 grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-5", children: [
            ...
            /* @__PURE__ */ jsx(
              MetricCard,
              {
                ...
                value: admissionsSummary.metrics.students_missing_program_enrollment_count,
                accent: "text-amber-600"
              }
            ),
            /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-6 xl:grid-cols-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-zinc-100 bg-white p-6 shadow-sm", children: [
            /* @__PURE__ */ jsx("h2", { className: "mb-4 text-lg font-semibold text-zinc-700", children: "Top Programs" }),
            /* @__PURE__ */ jsx("div", { className: "space-y-3", children: admissionsSummary.breakdowns.admissions_by_program?.length ? admissionsSummary.breakdowns.admissions_by_program.map(
              (row) => /* @__PURE__ */ jsxs(
                "div",
                {
                  className: "flex items-center justify-between rounded-lg bg-zinc-50 px-4 py-3",
                  children: [
                    /* @__PURE__ */ jsx("p", { className: "text-zinc-700", children: row.program_name }),
                    /* @__PURE__ */ jsx("span", { className: "font-semibold text-zinc-900", children: row.total })
                  ]
                },
                row.program_name
              )
            ) : /* @__PURE__ */ jsx("p", { className: "text-sm text-zinc-500", children: "No program data available." }) })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-zinc-100 bg-white p-6 shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-6 xl:grid-cols-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-zinc-100 bg-white p-6 shadow-sm", children: [
            /* @__PURE__ */ jsx("h2", { className: "mb-4 text-lg font-semibold text-zinc-700", children: "Missing Program Enrollment" }),
            /* @__PURE__ */ jsx("div", { className: "space-y-4", children: admissionsSummary.exceptions.students_missing_program_enrollment?.length ? admissionsSummary.exceptions.students_missing_program_enrollment.map(
            ...
            ) : /* @__PURE__ */ jsx("p", { className: "text-sm text-zinc-500", children: "No missing program enrollment cases found." }) })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-zinc-100 bg-white p-6 shadow-sm", children: [
      ...
      showDataQuality && dataQualitySummary && /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-4 grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4", children: [
            ...
            /* @__PURE__ */ jsx(
              MetricCard,
              {
                ...
                value: dataQualitySummary.metrics.multi_active_program_mapping_count,
                accent: "text-red-600"
              }
            )
          ] })
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-6 xl:grid-cols-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-zinc-100 bg-white p-6 shadow-sm", children: [
            /* @__PURE__ */ jsx("h2", { className: "mb-4 text-lg font-semibold text-zinc-700", children: "Students Without Program Enrollment" }),
            /* @__PURE__ */ jsx("div", { className: "space-y-4", children: dataQualitySummary.exceptions.students_without_program_enrollment?.length ? dataQualitySummary.exceptions.students_without_program_enrollment.map(
              (row) => /* @__PURE__ */ jsxs(
                "div",
                {
                  className: "rounded-lg border border-zinc-100 bg-zinc-50 px-4 py-3",
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-6 xl:grid-cols-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-zinc-100 bg-white p-6 shadow-sm", children: [
            /* @__PURE__ */ jsx("h2", { className: "mb-4 text-lg font-semibold text-zinc-700", children: "Multi-Active Program Mappings" }),
            /* @__PURE__ */ jsx("div", { className: "space-y-4", children: dataQualitySummary.exceptions.multiple_active_program_mappings?.length ? dataQualitySummary.exceptions.multiple_active_program_mappings.map(
              (row) => /* @__PURE__ */ jsxs(
                "div",
                {
                  className: "rounded-lg border border-zinc-100 bg-zinc-50 px-4 py-3",
                  children: [
                    /* @__PURE__ */ jsx("p", { className: "font-medium text-zinc-800", children: row.program_name }),
            ...
            ) : /* @__PURE__ */ jsx("p", { className: "text-sm text-zinc-500", children: "No multi-active program mapping cases found." }) })
          ] })
        ] })
      ] }),

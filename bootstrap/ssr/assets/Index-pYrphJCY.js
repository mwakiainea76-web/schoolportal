...
function Index({ lecture_rooms, departments, filters }) {
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-4 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-3xl font-semibold text-zinc-900", children: "Lecture Rooms" }),
          /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-zinc-500", children: "Manage halls and classrooms used in the timetable, including merged classes shared across programs." })
        ] }),
        /* @__PURE__ */ jsx(
          Link,
          {

...
const Edit = ({ program, certification_levels, departments }) => {
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Edit Program" }),
    /* @__PURE__ */ jsx("div", { className: "max-w-4xl mx-auto w-full", children: /* @__PURE__ */ jsx("div", { className: "bg-white rounded-lg border shadow overflow-hidden", children: /* @__PURE__ */ jsxs("form", { className: "w-full p-10 space-y-8", onSubmit: submit, children: [
      !canEditProgram ? /* @__PURE__ */ jsx("div", { className: "rounded border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-700", children: "You cannot fully update this program until both a department and a certification level exist." }) : null,

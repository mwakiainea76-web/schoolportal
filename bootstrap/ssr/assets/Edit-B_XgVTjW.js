...
const Edit = ({ department }) => {
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: " mx-auto w-full", children: /* @__PURE__ */ jsx("div", { className: "bg-white rounded-lg border shadow overflow-hidden", children: /* @__PURE__ */ jsxs("form", { className: "w-full p-10 space-y-8", onSubmit: submit, children: [

...
function Workspace({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-8 grid grid-cols-1 items-start gap-6 md:grid-cols-[minmax(280px,0.75fr)_minmax(420px,1.25fr)]", children: [
        /* @__PURE__ */ jsxs("section", { children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "min-h-[30rem] rounded-lg border border-zinc-100 bg-white p-6 shadow-sm", children: [
            /* @__PURE__ */ jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsx("h3", { className: "text-xl font-medium text-zinc-600", children: "Exam Bodies" }) }),
        ...
        /* @__PURE__ */ jsxs("section", { children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-zinc-100 bg-white p-6 shadow-sm", children: [
            /* @__PURE__ */ jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsxs("h3", { className: "text-xl font-medium text-zinc-600", children: [
              "Levels for ",

...
function Index({
  ...
  const loadAssessment = (e) => {
    ...
    router.get(
      ...
      {
        course_version_unit_code: filterForm.data.course_version_unit_code,
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsx(
                    InputError,
                    {
                      message: filterForm.errors.course_version_unit_code,
                      className: "mt-2"
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                  ...
                  /* @__PURE__ */ jsx(
                    ...
                    {
                      type: "submit",
                      disabled: !filterForm.data.course_version_unit_code,

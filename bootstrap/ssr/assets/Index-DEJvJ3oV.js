...
function Index({
  ...
  is_hod || is_trainer ? Boolean(current_department_id) : Boolean(
    filters.department_id && filters.curriculum_mapping_id && filters.module_number
  );
  ...
  const adminLoadPathReady = is_hod || is_trainer ? Boolean(current_department_id) : Boolean(
    filters.academic_session_id && filters.department_id && (filters.trainer_staff_id || filters.curriculum_mapping_id && filters.module_number)
  );
  const addTimetableHref = is_hod ? route("academic.timetables.hod.create") : route("academic.timetables.create");
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
      /* @__PURE__ */ jsx("section", { children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between", children: [
        /* @__PURE__ */ jsx(

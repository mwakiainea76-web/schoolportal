...
const TFooter$1 = React.memo(TFooter);
...
const Table = React.memo(DirectoryTable);
...
const Thead$1 = React.memo(Thead);
...
const THdata$1 = React.memo(THdata);
...
const Tdata$1 = React.memo(Tdata);
export {
  Table as T,
  Thead$1 as a,
  THdata$1 as b,

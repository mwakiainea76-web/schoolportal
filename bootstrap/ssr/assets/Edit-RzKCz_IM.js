...
import { g as gender_types, r as religion, d as disability_types, m as modules, a as relation_type } from "./constants-F4k489nP.js";
import "ziggy-js";
function FormSection({ number, title, children }) {
  return /* @__PURE__ */ jsxs("section", { className: "overflow-visible rounded-xl border border-zinc-200 p-5", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsx("div", { className: "flex h-7 w-7 items-center justify-center rounded-full bg-emerald-600 text-sm font-semibold text-white", children: number }),
...
function EditStudent({
  ...
  const existingCurriculumId = student.course_enrollment?.curriculum_id || student.courseEnrollment?.curriculum_id || student.course_enrollment?.curriculum_mapping?.curriculum_id || student.courseEnrollment?.curriculumMapping?.curriculum_id || student.course_enrollment?.curriculum_mapping?.curriculum?.id || student.courseEnrollment?.curriculumMapping?.curriculum?.id || "";
  ...
  const nextOfKin = student.user?.next_of_kin?.[0] || student.user?.nextofkin?.[0] || student.user?.nextOfKin?.[0] || student.user?.next_of_kin || student.user?.nextofkin || student.user?.nextOfKin || null;
  ...
  const selectedGenderLabel = findOptionLabel(gender_types, data.gender);
  const selectedReligionLabel = findOptionLabel(religion, data.religion);
  const selectedDisabilityLabel = findOptionLabel(
    disability_types,
    data.disability_type
  );
  const selectedModuleLabel = findOptionLabel(modules, data.current_module);
  const selectedRelationshipLabel = findOptionLabel(
    relation_type,
    data.kin_relationship
  );
  ...
  useEffect(() => {
    ...
    axios.get(route("students.exam-body-curriculums", data.exam_body_id)).then((response) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "rounded-xl pt-2", children: /* @__PURE__ */ jsx("div", { className: "overflow-visible ", children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-5 p-0", children: [
        /* @__PURE__ */ jsx(FormSection, { number: "1", title: "Personal Details", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx(
              SearchSelect,
              {
                ...
                value: data.religion,
                selectedLabel: selectedReligionLabel,
          ...
          data.is_pwd && /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx(
              SearchSelect,
              {
                ...
                selectedLabel: selectedDisabilityLabel,
        ...
        /* @__PURE__ */ jsx(FormSection, { number: "2", title: "Academic Details", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            hasLockedCourseEnrollment ? /* @__PURE__ */ jsx(
              ...
              SearchSelect,
              {
                ...
                selectedLabel: selectedExamBodyLabel,
                preloadOptions: true,
                minSearchLength: 3,
        ...
        /* @__PURE__ */ jsx(FormSection, { number: "3", title: "Next of Kin", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(
              InputLabel,
              {
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx(
              SearchSelect,
              {
                ...
                selectedLabel: selectedRelationshipLabel,

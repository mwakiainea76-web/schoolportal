  ...
  const renderFilterInput = (filter) => {
    ...
    return /* @__PURE__ */ jsx(
      SearchSelect,
      {
        ...
        preloadOptions: true,
        onChange: (option) => setFilterValue(
          filter.key,
          option?.id || "",
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 items-end gap-3 lg:grid-cols-[minmax(220px,300px)_minmax(300px,1fr)_auto_auto_auto]", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                selectedFilterDefinition ? renderFilterInput(selectedFilterDefinition) : /* @__PURE__ */ jsx("div", { className: "rounded-xl border border-dashed border-zinc-200 bg-zinc-50 px-4 py-2 text-sm text-zinc-400", children: "Select a column to show its input" })
              ] }),
              /* @__PURE__ */ jsx(
                "button",
                {

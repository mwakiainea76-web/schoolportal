...
function FeeAssignmentsIndex({ assignments, filters }) {
  ...
  const courseCertificationLabel = (assignment) => {
    const courseName = assignment.course_version_mapping?.course?.name || assignment.course_curriculum?.course?.name;
    const certificationName = assignment.course_version_mapping?.course?.certificationLevel?.name || assignment.course_version_mapping?.course?.certification_level?.name || assignment.course_curriculum?.course?.certificationLevel?.name || assignment.course_curriculum?.course?.certification_level?.name;

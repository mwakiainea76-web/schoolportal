  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full max-w-6xl animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
      /* @__PURE__ */ jsxs("div", { className: "rounded-[2rem] bg-[#1b263b] px-8 py-8 text-white shadow-xl", children: [
        ...
        /* @__PURE__ */ jsx("h1", { className: "mt-3 text-3xl font-bold tracking-tight", children: program?.name ?? "Course not assigned" }),
        /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-slate-300", children: program?.version ?? "Course version not assigned" })
      ] }),

        ...
        DirectoryTable,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs(Thead, { children: [
              /* @__PURE__ */ jsxs(THdata, { onClick: () => handleSort("transaction_date"), className: "cursor-pointer", children: [
                "Date ",
                renderArrow("transaction_date")
              ] }),
              /* @__PURE__ */ jsx(THdata, { children: "Student" }),
              /* @__PURE__ */ jsxs(THdata, { onClick: () => handleSort("type"), className: "cursor-pointer", children: [
                "Type ",
                renderArrow("type")
              ] }),
              /* @__PURE__ */ jsx(THdata, { children: "Reference" }),
              /* @__PURE__ */ jsx(THdata, { children: "Session" }),
              /* @__PURE__ */ jsxs(THdata, { onClick: () => handleSort("debit"), className: "cursor-pointer", children: [
                "Debit ",
                renderArrow("debit")
              ] }),
              /* @__PURE__ */ jsxs(THdata, { onClick: () => handleSort("credit"), className: "cursor-pointer", children: [
                "Credit ",
                renderArrow("credit")
              ] }),
            ...
            /* @__PURE__ */ jsx(TBody, { children: transactions?.data?.length ? transactions.data.map((transaction) => /* @__PURE__ */ jsxs(Trow, { children: [
              /* @__PURE__ */ jsx(Tdata, { children: transaction.transaction_date ?? "—" }),
            ...
            ] }, transaction.id)) : /* @__PURE__ */ jsx(Trow, { children: /* @__PURE__ */ jsx(Tdata, { colSpan: "9", className: "py-8 text-center text-zinc-500", children: "No ledger transactions found." }) }) })
          ]
        }
      ) })
    ] })

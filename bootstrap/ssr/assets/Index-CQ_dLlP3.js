...
function CourseVersionIndex({
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
      can("course-versions.view") ? /* @__PURE__ */ jsxs(
        "form",
        {
        ...
        DirectoryTable,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs(Thead, { children: [
              ...
              can("course-versions.edit") || can("course-versions.delete") ? /* @__PURE__ */ jsx(THdata, { children: /* @__PURE__ */ jsx("p", { className: "text-center", children: "Actions" }) }) : null
            ] }),
            /* @__PURE__ */ jsx(TBody, { children: curricula?.data?.length ? curricula.data.map((curriculum) => /* @__PURE__ */ jsxs(Trow, { children: [
              ...
              can("course-versions.edit") || can("course-versions.delete") ? /* @__PURE__ */ jsx(Tdata, { children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-x-10", children: [
                can("course-versions.edit") ? /* @__PURE__ */ jsx(
                  Link,
                  {
                    href: route(
                ...
                can("course-versions.delete") ? /* @__PURE__ */ jsx(
                  "button",
                  {

...
function Show({ invoice, sessionSummary }) {
  ...
  const course = invoice.enrollment?.course_enrollment?.course_version_mapping?.course?.name ?? "Not linked";
  const courseVersion = invoice.enrollment?.course_enrollment?.course_version_mapping?.course_version?.name ?? "Not linked";

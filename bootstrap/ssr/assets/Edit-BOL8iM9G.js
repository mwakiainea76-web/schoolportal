...
function Edit({ enrollment, statuses }) {
  ...
  return /* @__PURE__ */ jsxs(AuthenticatedLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-2xl w-full space-y-6", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-white border rounded-lg shadow-sm p-8 space-y-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "mt-1 px-3 py-2 bg-gray-50 border rounded text-sm text-gray-700", children: enrollment.registration_number })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [

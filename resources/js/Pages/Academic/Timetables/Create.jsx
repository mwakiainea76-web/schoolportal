...
export default function Create({
    ...
    const initialDepartment = is_admin
        ? ""
    ...
    const moduleOptions =
        data.department_id && data.curriculum_mapping_id
            ? [
                  ...new Set(
                      curriculum_units
                          .filter(
    ...
    const filteredUnits =
        data.department_id && data.curriculum_mapping_id && data.module_number
                ...
                >
                    ...
                    <div className="space-y-4 rounded-2xl border border-zinc-200 bg-zinc-50 p-5">
                        <div>
                            ...
                            <p className="text-sm text-zinc-500">
                                ...
                                trainer, room, and every selected time match
                                exactly.
                            </p>
                        </div>
                            ...
                            {filteredUnits.length ? (
                                ...
                                <p className="text-sm text-zinc-400">
                                    ...
                                    data.module_number
                                        ...
                                        : "Select a department, course version mapping, and module to load curriculum units."}
                                </p>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        <div>
                            ...
                            <SearchSelect
                                key={`trainer-${data.department_id}`}
                                routeName={null}

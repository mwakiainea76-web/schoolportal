    ...
    return (
        ...
        >
            ...
            <div className="mx-auto max-w-5xl space-y-6">
                {latestTransfer ? (
                    <section className="rounded-3xl border border-emerald-100 bg-emerald-50 p-6 text-sm text-emerald-900">
                        ...
                        <div className="mt-4 grid gap-3 md:grid-cols-2">
                            ...
                            <Info label="Temporary password" value={latestTransfer.temporary_password} />
                        </div>
                    </section>
                ) : null}

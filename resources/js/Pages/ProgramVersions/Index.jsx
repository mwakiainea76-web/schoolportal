...
export default function ProgramVersionIndex({ curricula }) {
            ...
            <div className="mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                >
                    <Thead>
                        ...
                        {can("program-versions.edit") ||
                        can("program-versions.delete") ? (
                            <THdata>

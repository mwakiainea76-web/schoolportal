...
export default function Index({
    ...
    // Reset entries when the loaded unit changes, but NOT on every submit
    ...
    return (
        ...
        >
            ...
            <div className="mx-auto max-w-6xl space-y-8">
                ...
                {/* ── Form 2: Enter Marks (only when a unit is loaded) ── */}
                {selected_unit ? (
                    <form
                        onSubmit={submit}
                        className="space-y-6 rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm"
                    >
                        ...
                        {/* Assessment Type & Number live here and do NOT reset on submit */}
                        ...
                        {/* Hidden fields carry all filter state to the POST */}
                        <input
                            type="hidden"
                            value={filters.program_version_unit_code}
                    ...
                    <div className="rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm">
                        <div className="flex items-center gap-3 rounded-2xl border border-blue-200 bg-blue-50 px-5 py-4 text-sm text-blue-800">
                            ...
                            <p className="ml-auto text-xs">
                                Enter the unit code and click "Load Unit" above to
                        ...
                        <div className="mt-6 overflow-hidden rounded-2xl border border-zinc-100">
                            ...
                            {submitted_marks.length ? (
                                ...
                                <div className="px-4 py-8 text-center text-sm text-zinc-500">
                                    No submitted marks found for this assessment yet.
                                </div>
                            )}
                        </div>
                    </div>

                            ...
                            {adjustments.data.length ? (
                                adjustments.data.map((adjustment) => (
                                    ...
                                    >
                                        ...
                                        <Tdata className="capitalize text-gray-600">
                                            {adjustment.type}
                                        </Tdata>
                                        <Tdata
                                            className={`text-right font-mono font-bold ${Number(adjustment.value) < 0 ? "text-emerald-600" : "text-rose-600"}`}
                                        >
                                        ...
                                        <Tdata className="text-gray-600 text-sm">
                                            {adjustment.approver
                                                ? `${adjustment.approver.first_name} ${adjustment.approver.last_name}`
                                                : "—"}
                                        </Tdata>

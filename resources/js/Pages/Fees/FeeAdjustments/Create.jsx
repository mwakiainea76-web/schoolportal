...
export default function Create({ invoices, users }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route("fees.adjustments.store"), {
            preserveScroll: true,
        });
    };
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Create Fee Adjustment" />

            <div className="mx-auto max-w-4xl w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="mb-6">
                    <h1 className="text-2xl font-bold text-gray-800 tracking-tight">Create Fee Adjustment</h1>
                    <p className="text-gray-600 mt-1">Apply a discount or surcharge to a specific student invoice.</p>
                </div>
                ...
                >
                        ...
                        <div>
                            ...
                            <div className="mt-3 flex gap-6">
                                <label className="inline-flex items-center cursor-pointer group">
                                    ...
                                    />
                                    <span className="ml-2 text-sm font-medium text-gray-700 group-hover:text-emerald-600 transition-colors">Fixed Amount</span>
                                </label>
                                <label className="inline-flex items-center cursor-pointer group">
                                    <input
                                        type="radio"
                                        ...
                                        className="text-emerald-600 focus:ring-emerald-500 w-4 h-4"
                                    />
                                    <span className="ml-2 text-sm font-medium text-gray-700 group-hover:text-emerald-600 transition-colors">Percentage</span>
                                </label>
                            </div>
                    ...
                    <div>
                        ...
                        <SearchSelect
                            routeName="students.search" // Fallback to student search for now if staffs search missing, or I'll add it
                    ...
                    <div className="flex justify-between pt-8 border-t">
                        ...
                        <button
                            type="submit"
                            disabled={processing}
                            className="px-8 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition disabled:opacity-50 font-bold shadow-sm shadow-emerald-200"
                        >

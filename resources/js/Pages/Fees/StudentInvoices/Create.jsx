...
export default function Create({ enrollments, feeModels }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route("fees.student-invoices.store"), {
            preserveScroll: true,
        });
    };
    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="mx-auto max-w-5xl w-full">
                <div className="mb-6">
                    <h1 className="text-2xl font-semibold text-gray-800">Create Student Invoice</h1>
                    <p className="text-sm text-gray-600">Generate a new invoice for a student enrollment.</p>
                </div>
                ...
                >
                    ...
                    <div className="grid gap-6 grid-cols-1 md:grid-cols-3">
                        ...
                        <div>
                            <InputLabel value="Initial Credit Balance" />
                            <TextInput
                                type="number"
                                step="0.01"
                                name="credit_balance"
